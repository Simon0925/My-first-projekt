class AdminPanel extends HTMLElement {
  ...
  <div id="myModal" class="modal"> 
     ...
     <div class="rebus_list" id="rebus_list">
        ...
        <button class="back-to-tasklist" id="back-tasklist" >Back</button>
    ...
    connectedCallback() {
     ...
     this.backTasklist2 = this.shadow.querySelector("#back-tasklist")
     
     this.backTasklist2.onclick = function(event){
            console.log("hello")
            this.post.style.display = "inline";
            this.list.style.display = "inline";
            this.rebusList.style.display="none";
     ...
     this.post.onclick = function(event) {
        ...
        this.rebusPhoto.onchange = function ( event ) {
            ...
            this.postRebusButton.onclick = function (event) {
                ...
                this.qwestionText.target.valid = "";
            }.bind(this)
                ...
                rebus.forEach(reb => {
                    ...
                    let inputImg = document.createElement("input")
                        inputImg.type = "file"
                         ...
                         inputImg.id = `input${reb.id}`
                         let lbl = document.createElement("label")
                         lbl.htmlFor = inputImg.id
                         lbl.className = "buttonlbl" 
                        ...
                        reader.onload = function dowload (ev) {
                    ...
                    editBut.onclick = function editItem(event) {
                        ...
                        nameinfo.style.border = "3px solid #b99403"
...
//______________________acount LIST STASRT______________________\\
